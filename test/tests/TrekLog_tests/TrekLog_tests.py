...
#     TrekLog and accompanying source files are licensed under the Creative
...
#     Independently - The licensor cannot revoke these freedoms as long as
...
"""
Module containing TestCases for src/TrekLog/TrekLog.py

Execute this module directly to run just these tests.
"""
